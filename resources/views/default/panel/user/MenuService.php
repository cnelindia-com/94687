        ...
        $menu = [
            ...
            'ext_fashion_studio' => [
                ...
                'active_condition' => [
                  ...
                  'show_condition' => MarketplaceHelper::isRegistered('fashion-studio') && auth()->check() && (
                      auth()->user()->isSuperAdmin()
                      || (auth()->user()->relationPlan && auth()->user()->relationPlan->create_video && auth()->user()->isTeamCreator())
                  ),
                'badge'          => 'new',
            ],
