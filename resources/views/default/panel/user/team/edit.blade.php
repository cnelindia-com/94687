	...
	<div class="py-10 row">
		<div class="col-md-5 mx-auto">
			...
			<form
				...
				method="post"
				x-data="{ selectedRole: {{ (int) $team_role }} }"
			>
				@csrf
<div class="col-md-12">
    <div class="mb-3">
        ...
        >
            <option value="1" {{ (int) $team_role === 1 ? 'selected' : '' }}>
                Creator
            </option>
            <option value="2" {{ (int) $team_role === 2 ? 'selected' : '' }}>
                Viewer
            </option>
        </select>
