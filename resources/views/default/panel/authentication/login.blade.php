...
@section('form')
    ...
    >
        ...
        {{-- YE NEECHE WALI LINE ADD KARO --}}
        <div id="errorsshow_login" class="text-sm text-red-500 mt-1"></div>

        
        <div
            class="mt-4 hidden rounded-lg bg-green-600 px-4 py-2 text-center text-sm font-medium text-white"
            id="login-inline-popup"
        ></div>
