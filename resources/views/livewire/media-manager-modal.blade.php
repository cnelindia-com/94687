						...
						@forelse ($images as $image)
							...
							>
								<div class="relative overflow-hidden rounded-lg">
									...
									<div class="absolute inset-x-0 bottom-6 truncate bg-background/95 px-1 py-0.5 text-[10px] text-heading-foreground opacity-0 transition-opacity duration-300 group-hover:opacity-100">
										{{ __('By') }} {{ $image->creator_name ?? __('Unknown') }}
									</div>
						...
						@forelse ($videos as $video)
							...
							>
								<div class="relative overflow-hidden rounded-lg">
									...
									<div class="absolute inset-x-0 bottom-6 z-1 truncate bg-background/95 px-1 py-0.5 text-[10px] text-heading-foreground opacity-0 transition-opacity duration-300 group-hover:opacity-100">
										{{ __('By') }} {{ $video->creator_name ?? __('Unknown') }}
									</div>
								...
								<div class="flex items-center space-x-3">
									...
									<div class="min-w-0 flex-1">
										...
										<p class="text-xs text-gray-400">
											{{ __('By') }} {{ $file->creator_name ?? __('Unknown') }}
										</p>
										<p class="text-xs text-gray-400">
											{{ $file->format_date }}
										</p>
