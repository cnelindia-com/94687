...
class SubscriptionPlanCreate extends Component
{
    ...
    public function rules(): array
    {
        return array_merge([
            ...
            // pritam
             'plan.image_2k'                               => 'nullable|boolean',
             'plan.image_4k'                               => 'nullable|boolean',
             'plan.create_video'                           => 'nullable|boolean',
             'plan.change_models'                          => 'nullable|boolean',
             'plan.default_plan'                           => 'nullable|boolean',

             'plan.total_credits' => 'required|integer|min:0',
             'plan.image_1k_weight' => 'nullable|integer|min:0',
             'plan.image_2k_weight' => 'nullable|integer|min:0',
             'plan.image_4k_weight' => 'nullable|integer|min:0',
             'plan.create_video_weight' => 'nullable|integer|min:0',
             'plan.image_generation_weight' => 'nullable|integer|min:0',
    ...
    public function submit(): RedirectResponse|Redirector
    {
        ...
        // pritam
    //       $this->plan->create_video = (bool) $this->plan->create_video;
    // $this->plan->change_models = (bool) $this->plan->change_models;

    if ($this->plan->default_plan) {

    Plan::where('id', '!=', $this->plan->id)
        ->update([
            'default_plan' => 0
        ]);
}
