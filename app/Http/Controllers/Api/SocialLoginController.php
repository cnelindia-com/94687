...
class SocialLoginController extends Controller
{
    ...
    public function google(Request $request): JsonResponse
    {
        ...
        if ($checkUser) {
            ...
            $teamMember = TeamMember::where('email', $googleUser->getEmail())
                ->where('status', 'waiting')
                ->first();

            $isTeamInviteEmail = (bool) $teamMember;
            ...
            if ($teamMember) {
                $userData['team_id'] = $teamMember->team_id;
                $userData['team_manager_id'] = $teamMember->team?->user_id;
            }
    ...
    public function apple(Request $request): JsonResponse
    {
        ...
        if ($checkUser) {
            ...
            $isTeamInviteEmail = TeamMember::where('email', $appleUser->getEmail())->exists();
