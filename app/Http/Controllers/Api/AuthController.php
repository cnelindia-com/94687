...
class AuthController extends Controller
{
    ...
    public function register(Request $request): JsonResponse
    {
        ...
        if (Helper::appIsDemo()) {
            ...
            // ✅ Check if user is joining as a team member
            ...
            $allocatedCredits = ($teamMember && $teamMember->role === 'creator')
                ? (int) ($teamMember?->remaining_words ?? $teamMember?->credits ?? 0)
                : null;
            ...
            // ✅ Only give free credits and trial plan to NON-team members
            if (! $teamMember) {
            ...
            } elseif ($allocatedCredits > 0 && $teamMember->role === 'creator') {
