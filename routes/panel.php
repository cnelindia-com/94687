...
Route::middleware(['auth', 'updateUserActivity', 'check.viewer.role'])
    ->prefix('dashboard')
    ->name('dashboard.')
        ...
        Route::prefix('user')
            ...
            ->group(callback: function () {
                ...
                Route::group([
                    ...
                    Route::post('{team}/member/{teamMember}/suspend', 'teamMemberSuspend')->name('member.suspend');
                });
               ...
               Route::middleware(['auth', 'check.viewer.role'])->prefix('dashboard/user/fashion-studio')->group(function () {
    Route::get('/user_settings', [\App\Extensions\FashionStudio\Controllers\UserSettingsController::class, 'index'])
        ->name('dashboard.user.fashion-studio.user_settings');
});
        ...
        Route::prefix('admin')
            ...
            ->group(function () {
                ...
                Route::prefix('users')->name('users.')->group(function () {
                    ...
                    Route::post('send-password-reset/{user}', [AdminController::class, 'usersSendPasswordReset'])
        ...
        Route::prefix('support')->name('support.')->group(function () {
            ...
            Route::middleware('admin')->group(function () {
                Route::get('/settings', [SupportController::class, 'supportSettings'])->name('settings');
                Route::put('/settings', [SupportController::class, 'updateSupportSettings'])->name('settings.update');
            });
        });

        // Tutorial Page
        Route::get('/tutorial', [SupportController::class, 'tutorial'])->name('tutorial');
        Route::get('/tutorial/settings', [SupportController::class, 'tutorialSettings'])->name('tutorial.settings');
        Route::post('/tutorial/upload', [SupportController::class, 'uploadTutorialVideo'])->name('tutorial.upload');
